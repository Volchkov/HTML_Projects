...
print "<CENTER><A HREF='vc_vvv1.php'>Clear Page</A></CENTER>";
...
// show info data   
        ...
        print "<TABLE align=\"center\" border=\"0\" padding=\"10\">";
        
		print "<TR>";	
			print "<TD align=\"center\">SIP Server</TD>";
            print "<TD>";
            print "</TD>";
		    print "<TD align=\"center\">vg3.vegatele.com</TD>";
		print "</TR>";
		print "<TR>";
		
			print "<TD align=\"center\">SIP Domain</TD>";
			print "<TD>";
            print "</TD>";
			print "<TD align=\"center\">vg3.vegatele.com</TD>";
		...
		print "<TR>";
			...
			print "<TD align=\"center\">SIP Port</TD>";
			print "<TD>";
            print "</TD>";
			print "<TD align=\"center\">5060</TD>";
...
print "<TR>";
print "<TD>";
print "<FORM action=\"vc_vvv1.php\" method=\"GET\">";
